...
import com.ecirstea.auth.HttpBasicAuth;
import com.ecirstea.auth.HttpBearerAuth;
import com.ecirstea.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "http://10.0.2.2:9100";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
